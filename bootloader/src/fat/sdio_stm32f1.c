...
*/
/**************************************************************************/
DRESULT disk_read(uint8_t drv,uint8_t *buff,LBA_t sector,unsigned int count)
{
	switch (drv) 
	{
		case SDIO_DRIVE:
...
/**************************************************************************/
#if FF_FS_READONLY == 0
DRESULT disk_write(uint8_t drv,const uint8_t *buff,LBA_t sector,unsigned int count)
{
	switch (drv) 
	{
		case SDIO_DRIVE:
