...
const uint32_t GPIO_CLK[LEDn] = {LED1_GPIO_CLK};
 ...
 GPIO_TypeDef* BUTTON_PORT[BUTTONn] = {PAGE_BUTTON_PORT, KEY1_BUTTON_PORT, 
                                       KEY2_BUTTON_PORT}; 

 const uint16_t BUTTON_PIN[BUTTONn] = {PAGE_BUTTON_PIN, KEY1_BUTTON_PIN, 
                                       KEY2_BUTTON_PIN}; 

 const uint32_t BUTTON_CLK[BUTTONn] = {PAGE_BUTTON_CLK, KEY1_BUTTON_CLK,
                                       KEY2_BUTTON_CLK};
 ...
 const uint16_t BUTTON_PORT_SOURCE[BUTTONn] = {PAGE_BUTTON_PORT_SOURCE,
                                               KEY1_BUTTON_PORT_SOURCE, 
                                               KEY2_BUTTON_PORT_SOURCE};
								 
 const uint16_t BUTTON_PIN_SOURCE[BUTTONn] = {PAGE_BUTTON_PIN_SOURCE,
                                              KEY1_BUTTON_PIN_SOURCE, 
                                              KEY2_BUTTON_PIN_SOURCE}; 

 const uint16_t BUTTON_IRQn[BUTTONn] = {PAGE_BUTTON_IRQn, KEY1_BUTTON_IRQn, 
                                        KEY2_BUTTON_IRQn};
